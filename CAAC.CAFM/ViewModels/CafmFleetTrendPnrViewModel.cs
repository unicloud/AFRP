...
{
    [Export(typeof(CafmFleetTrendPnrViewModel))]
    [PartCreationPolicy(System.ComponentModel.Composition.CreationPolicy.Shared)]
    public class CafmFleetTrendPnrViewModel : NotificationObject, IPartImportsSatisfiedNotification, IConfirmNavigationRequest
    {
        public CafmFleetTrendPnrViewModel()
        {
        ...
        private readonly CAAC.CAFM.Views.CafmFleetTrendPnrView _view = ServiceLocator.Current.GetInstance<CAAC.CAFM.Views.CafmFleetTrendPnrView>();
        ...
        private void OnExport(object sender)
        {
            ...
            if (menu != null && menu.Header.ToString() == "导出源数据")
            {
                if (menu.Name == "LineGridData")
                {
                    ...
                    columnsList.Add("SeatAmount", "期末座位数");
                    columnsList.Add("LoadAmount", "期末商载量");
                    ExportRadgridview = ImageAndGirdOperation.CreatDataGridView(columnsList, FleetAircraftTrendLineCollection, "AircraftTrent");
                ...
                else if (menu.Name == "BarGridData")
                {
                    ...
                    columnsList.Add("SeatAmount", "座位净增数");
                    columnsList.Add("LoadAmount", "商载净增数");
                    ExportRadgridview = ImageAndGirdOperation.CreatDataGridView(columnsList, FleetAircraftTrendBarCollection, "AircraftTrent");
                }
                else if (menu.Name == "AircraftPieGridData")
                {
                    ...
                    ExportRadgridview = ImageAndGirdOperation.CreatDataGridView(columnsList, FleetAircraftCollection, "PieAircraftTrent");
                }
                else if (menu.Name == "SeatPieGridData")
                {
                    ...
                    Dictionary<string, string> columnsList = new Dictionary<string, string>();
                    columnsList.Add("Aircraft", "航空公司");
                    columnsList.Add("Amount", "选定时间点座位数");
                    ExportRadgridview = ImageAndGirdOperation.CreatDataGridView(columnsList, FleetSeatCollection, "PieAircraftTrent");
                }
                else if (menu.Name == "LoadPieGridData")
                {
                    ...
                    ExportRadgridview = ImageAndGirdOperation.CreatDataGridView(columnsList, FleetLoadCollection, "PieAircraftTrent");
                }
                i = 1;
