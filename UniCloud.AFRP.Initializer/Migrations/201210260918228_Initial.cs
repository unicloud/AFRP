                ...
                c => new
                    {
                        ...
                        LoginUser = c.String(maxLength: 30),
                ...
                c => new
                    {
                        ...
                        RegNumber = c.String(maxLength: 6),
                ...
                c => new
                    {
                        ...
                        DocNumber = c.String(maxLength: 30),
                        AttachDocFileName = c.String(maxLength: 30),
                        AttachDoc = c.Binary(),
                        Status = c.Int(nullable: false),
                    })
                ...
                c => new
                    {
                        ...
                        ApprovalNumber = c.String(maxLength: 30),
                        ApprovalDocFileName = c.String(maxLength: 30),
                        AttachDoc = c.Binary(),
                        Status = c.Int(nullable: false),
                    })
