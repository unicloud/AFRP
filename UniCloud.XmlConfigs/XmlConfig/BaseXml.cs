...
namespace UniCloud.Fleet.XmlConfigs
{
    ...
    public abstract class BaseXml
    {
        ...
        {
            return _XmlService.AllAirlines.FirstOrDefault(p => p.IsCurrent == true).ShortName;
        }
        ...
        {
            return GetAllAircraftOperationHistory().Select(p => p.Airlines.ShortName).Distinct().ToList();
        }
