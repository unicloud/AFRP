namespace CAAC.Fleet.MailService
{
    partial class ServiceInstaller
    {
        ...
        private void InitializeComponent()
        {
            ...
            // 
            this.XmlConfigServiceInstaller.Description = "民航局机队数据系统服务，生成统计分析相关数据";
            this.XmlConfigServiceInstaller.DisplayName = "民航局机队数据系统服务";
            this.XmlConfigServiceInstaller.ServiceName = "CAFMDataService";
