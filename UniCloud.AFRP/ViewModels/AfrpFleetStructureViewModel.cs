...
{
    [Export(typeof(AfrpFleetStructureViewModel))]
    [PartCreationPolicy(System.ComponentModel.Composition.CreationPolicy.Shared)]
    public class AfrpFleetStructureViewModel : NotificationObject, IPartImportsSatisfiedNotification, IConfirmNavigationRequest
    {
        public AfrpFleetStructureViewModel()
        {
        ...
        private readonly UniCloud.AFRP.Views.AfrpFleetStructureView _view = ServiceLocator.Current.GetInstance<UniCloud.AFRP.Views.AfrpFleetStructureView>();
        ...
        void ElementExporting(object sender, GridViewElementExportingEventArgs e)
        {
            ...
            if (e.Element == ExportElement.Cell &&
                e.Value != null)
            {
                if (i % 5 == 3 && i >= 8 && (sender as RadGridView).Name == "FleetStructure")
                {
