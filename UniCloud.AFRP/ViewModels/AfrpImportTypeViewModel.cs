...
{
    [Export(typeof(AfrpImportTypeViewModel))]
    [PartCreationPolicy(System.ComponentModel.Composition.CreationPolicy.Shared)]
    public class AfrpImportTypeViewModel : NotificationObject, IPartImportsSatisfiedNotification, IConfirmNavigationRequest
    {
        public AfrpImportTypeViewModel()
        {
        ...
        private readonly UniCloud.AFRP.Views.AfrpImportTypeView _view = ServiceLocator.Current.GetInstance<UniCloud.AFRP.Views.AfrpImportTypeView>();
        ...
        private void OnExport(object sender)
        {
            ...
            if (menu != null && menu.Header.ToString() == "导出源数据")
            {
                if (menu.Name == "TrendGridData")
                {
                    ...
                    ExportRadgridview = ImageAndGridOperation.CreatDataGridView(columnsList, FleetImportTypeTrendCollection, "LineImportType");
                ...
                else if (menu.Name == "ImportTypePieGridData")
                {
                    ...
                    ExportRadgridview = ImageAndGridOperation.CreatDataGridView(columnsList, FleetImportTypeCollection, "PieImportType");
        ...
        void ElementExporting(object sender, GridViewElementExportingEventArgs e)
        {
            ...
            if (e.Element == ExportElement.Cell &&
                e.Value != null)
            {
                if (i % 5 == 3 && i >= 8 && (sender as RadGridView).Name == "LineImportType")
                {
