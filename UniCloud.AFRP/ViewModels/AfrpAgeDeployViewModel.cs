...
{
    [Export(typeof(AfrpAgeDeployViewModel))]
    [PartCreationPolicy(System.ComponentModel.Composition.CreationPolicy.Shared)]
    public class AfrpAgeDeployViewModel : NotificationObject, IPartImportsSatisfiedNotification, IConfirmNavigationRequest
    {
        public AfrpAgeDeployViewModel()
        {
        ...
        private readonly UniCloud.AFRP.Views.AfrpAgeDeployView _view = ServiceLocator.Current.GetInstance<UniCloud.AFRP.Views.AfrpAgeDeployView>();
