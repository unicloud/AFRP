...
{
    [Export(typeof(AfrpFleetTrendCargoViewModel))]
    [PartCreationPolicy(System.ComponentModel.Composition.CreationPolicy.Shared)]
    public class AfrpFleetTrendCargoViewModel : NotificationObject, IPartImportsSatisfiedNotification, IConfirmNavigationRequest
    {
        public AfrpFleetTrendCargoViewModel()
        {
        ...
        private readonly UniCloud.AFRP.Views.AfrpFleetTrendCargoView _view = ServiceLocator.Current.GetInstance<UniCloud.AFRP.Views.AfrpFleetTrendCargoView>();
        ...
        #region Local 方法 InitalizerRadWindows --初始化提示窗体
        ...
        #region ViewModel 属性 FleetAircraftCollection --选中时间点的飞机数据集合
        ...
        public class FleetAircraftTrend
        {
            ...
            public int LoadAmount1 { get; set; }//座位数的总数
